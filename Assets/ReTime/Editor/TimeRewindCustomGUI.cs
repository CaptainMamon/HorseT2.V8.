...
public class TimeRewindCustomGUI : Editor {
	public override void OnInspectorGUI(){
		...
		script.RewindSpeed = EditorGUILayout.Slider(new GUIContent("Rewind Speed", "The speed scale float in which the rewind will play at. From 0.1 - 5.0"), script.RewindSpeed, 0.1f, 20f);
